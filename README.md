...
This project demonstrates the full local preprocessing pipeline of working directly with raw Landsat Level-1 data without any cloud-based 
...
2. **Radiometric calibration** — converted raw Digital Numbers (DN) to Top-of-Atmosphere (TOA) reflectance using USGS scaling formula:
   `TOA = (MULT × DN + ADD) / sin(sun_elevation)`
3. **Solar angle correction** — normalized for sun angle at acquisition time (sun elevation: 39.99°)
...
|---|---|---|---|
| Water | 0.77 | 0.72 | 0.74 |
| Forest | 0.89 | 0.92 | 0.91 |
| Cropland | 0.86 | 0.89 | 0.88 |
| Urban | 0.80 | 0.71 | 0.75 |
| Bare soil | 0.62 | 0.01 | 0.03 |
...
- **Cloud cover: 4.8%** — the June 2023 scene has minimal cloud contamination, covering the majority of the scene with valid data.
...
- Dark Object Subtraction: Chavez (1988) — An Improved Dark-Object Subtraction 
  Technique for Atmospheric Scattering Correction of Multispectral Data